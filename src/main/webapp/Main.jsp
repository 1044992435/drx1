...
<div class="row">
    <div class="col-md-3">
        ...
        <a class="list-group-item" data-addtab="userMenu" data-target="#tabs"   style="color: #0f0f0f" data-url="http://www.baidu.com">
           管理菜单
        </a>
...
<script type="text/javascript">
    ...
    $(function (){
        $.ajax({
            type:"post",
            url:"<%=request.getContextPath()%>/comment/findhomepage",
            datatype:"json",
